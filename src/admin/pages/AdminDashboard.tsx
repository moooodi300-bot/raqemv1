...
export function AdminDashboard() {
  ...
  const statCards = [
    { label: 'Total Businesses', value: stats.totalBusinesses, icon: Building2, color: 'text-blue-600', bg: 'bg-blue-100' },
    { label: 'Active Subscriptions', value: stats.activeBusinesses, icon: Activity, color: 'text-emerald-600', bg: 'bg-emerald-100' },
    { label: 'Monthly Recurring Revenue', value: `${stats.mrr} SAR`, icon: DollarSign, color: 'text-amber-600', bg: 'bg-amber-100' },
    { label: 'Active Users', value: stats.totalUsers, icon: Users, color: 'text-indigo-600', bg: 'bg-indigo-100' },
    { label: 'Platform Customers', value: stats.totalCustomers, icon: Users, color: 'text-purple-600', bg: 'bg-purple-100' },
    { label: 'Platform Sales', value: `${stats.totalSales.toFixed(2)} SAR`, icon: CreditCard, color: 'text-pink-600', bg: 'bg-pink-100' },
  ];
